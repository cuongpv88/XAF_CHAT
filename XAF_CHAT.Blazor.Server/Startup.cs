...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddTransient<IEdmModelCustomizer, MyEdmModelCustomizer>();
        services.AddTransient<IChatManager, ChatManager>();
        
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<XAF_CHATBlazorApplication>();
            builder.Modules
        ...
        services
            .AddXafWebApi(Configuration, options => {
                ...
                options.BusinessObject<ChatMessage>();
            })
            .AddXpoServices();
        services
            .AddControllers()
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "Chat API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the Chat.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Chat WebApi v1");
            });
        }
        else {
